...
This is a BalderHub package that can be used to validate the CREATION, RETRIEVAL, UPDATE and DELETION of any kind of data.

.. note::
   Please note, this package is still under development. If you would like to contribute, take a look into the
   `project <https://github.com/balder-dev/balderhub-crud/>`_.
