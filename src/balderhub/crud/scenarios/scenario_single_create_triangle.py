...
class ScenarioSingleCreateTriangle(balder.Scenario):
    ...
    def test_create_valid(self, valid_example: ExampleDataProviderFeature.NamedExample):
        ...
        filled_data_class = self.Creator.creator.fill(valid_example.data)
    ...
    @balder.parametrize_by_feature('invalid_example', (Creator, 'example', 'get_invalid_examples'))
    def test_create_invalid(self, invalid_example: ExampleDataProviderFeature.NamedExample):
        ...
        self.Creator.creator.load()
        filled_data_class = self.Creator.creator.fill(invalid_example.data)
        self.Creator.creator.save()
    ...
    @balder.parametrize_by_feature('without_optional_field', (Creator, 'creator', 'resolved_optional_fields'))
    def test_create_valid_without_single_optional_field(self, without_optional_field: str):
        ...
        self.Creator.creator.load()
        filled_data_class = self.Creator.creator.fill(data_to_fill)
        self.Creator.creator.save()
    ...
    @balder.parametrize_by_feature('without_field', (Creator, 'creator', 'resolved_fields_with_default_values'))
    ...
    @balder.parametrize_by_feature('without_mandatory_field', (Creator, 'creator', 'resolved_mandatory_fields'))
    def test_create_invalid_with_missing_mandatory_field(self, without_mandatory_field: str):
        ...
        error_messages = self.Creator.creator.get_active_error_messages()
        expected_error_messages = self.Creator.creator.get_expected_error_message_for_missing_mandatory_field(filled_data_class, without_mandatory_field)
